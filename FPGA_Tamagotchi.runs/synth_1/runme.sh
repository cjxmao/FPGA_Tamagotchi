...
HD_PWD='C:/Users/Stary/Documents/MIT/Classes/6.111/Final_Project/FPGA_Tamagotchi/FPGA_Tamagotchi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tippity_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tippity_top_level.tcl
